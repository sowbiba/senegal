...
use Pfd\Sdk\Model\BaseModel;
use Pfd\Sdk\Model\UploadableInterface;
use Pfd\Sdk\SdkInterface;
use Senegal\Api\SdkBundle\Listener\UploadableListener;
...
class UploadableListenerTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->slugifier = $this->getMockBuilder('Senegal\Api\SdkBundle\Tools\UploadedFileSlugifier')
