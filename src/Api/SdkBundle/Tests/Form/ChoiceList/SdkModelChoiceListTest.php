...
namespace Api\SdkBundle\Tests\Form\ChoiceList;
use Api\SdkBundle\Form\ChoiceList\SdkModelChoiceList;
...
class SdkModelChoiceListTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->manager = $this->getMockBuilder('Api\Sdk\Mediator\SdkMediator')
