...
namespace Api\SdkBundle\Tests\Request\ParamConverter;

use Symfony\Component\HttpFoundation\Request;
use Api\Sdk\Mediator\SdkMediator;
use Api\SdkBundle\Request\ParamConverter\ModelParamConverter;
...
class ModelParamConverterTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->sdkMediator = $this->getMockBuilder('Api\Sdk\Mediator\SdkMediator')->disableOriginalConstructor()->getMock();
    ...
    public function testApplyWithId($id)
    {
        ...
        $sdk = $this->getMock('Api\Sdk\SdkInterface');
    ...
    public function testSupports()
    {
        ...
        $configuration = $this->createConfiguration('Api\Sdk\Model\Chapter');
